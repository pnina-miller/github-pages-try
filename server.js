...
app.get('/user/get', (req, res) => {console.log('user');
const user={misparChativa:'22',misparAgaf:'99',kodSector:'99',misparMakal:'88'}
  res.json({data:{userDataMf:user}})
})
app.get('/shofar/combobox', (req, res) => {console.log('shofar/combobox');
...
app.get('/shofar/pirteyProject/get', (req, res) => {console.log('shofar/pirteyProject/get');
  res.json({data:details})
})
app.get('/common/sectors', (req, res) => {console.log('sectors');
res.json({data:'jj'})
})
app.get('/common/makals', (req, res) => {console.log('makals');
res.json({data:'jj'})
})
app.get('/common/tables/tableColumnsByUser', (req, res) => {console.log('tableColumnsByUser');
  res.json({data:col})
})
app.get('/common/agafim', (req, res) => {console.log('agafim');
  res.json({data:{}})
})
app.get('/common', (req, res) => {console.log('common all');
  res.json({data:'common all'})
})
app.get('/shofar/amalot', (req, res) => {console.log('amalot');
  res.json({data:{amalot:{
...
app.get('/shofar/natuney-mashkanta', (req, res) => {console.log('shofar all');

  res.json({data:{natuneyMashkantaData: {
    ...
    dargatMashkantaOptLst:[{   id: 'string',
      value: 'string',
      shortDesc: 'string',
      longDesc: 'string'},
      {   id: 'string2',
...
app.get('/shofar/*', (req, res) => {console.log('shofar all');
  res.json({data:'shofar all'})
})
app.get('/*', (req, res) => {console.log('all');
  res.json({data:'all'})
})
